...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-6">
      <button type="button" class="btn btn-primary mb-2 tombolTambahPotonganGaji" data-toggle="modal" data-target="#formModalPotonganGaji">
              ...
              <tbody>
                <?php $no = 1; foreach($pot_gaji as $p) : ?>
                  <tr>
                    ...
                    <td>
                        <a class="btn btn-sm btn-primary" href="<?= base_url('admin/potongan_gaji/update_data/' . $p['id_poga']); ?>">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a href="<?= base_url('admin/potongan_gaji/hapus/') . $p['id_poga']; ?>" onclick="return confirm('Yakin ingin menghapus?')" class="btn btn-sm btn-danger">
...
<!-- Modal Tambah/Ubah Potongan Gaji -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('admin/potongan_gaji'); ?>" method="post">
